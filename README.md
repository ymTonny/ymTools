...
| unique                 |数组去重（新数组）       |Array                                        |
| unique1                |数组去重（原数组）       |Array                                        |
| unique2                |数组对象去重(根据对象名)  |(键名)                                      |
| remove                 |删除数组中元素           |name                                         |
| removeObject           |删除数组对象中的元素     |键值                                         |
| arrMax                 |数组最大值(number型)     |无                                           |
| arrMin                 |数组最小值(number型)     |无                                           |
| arrRand                |数组随机排列             |无                                           |
| arrRand1               |数组随机排序             |无                                           |
...
|filterHTML              |将html转成字符串输出       |(str) `<p>123</p>`                         |
...
## //=========css伪类=========//
 1. clip-path:polygon() 裁剪图片
 2. pointer-event:none; 禁止点击
 3. caret-color:red;  修改光标颜色
 4. user-select:none; 禁用文本被选中 IE6-9使用onselectstart="return false"
 5. :target 实现折叠面板  通过a标签锚点#后面内容控制
 6. ::selection 选中文本颜色
 7. ::first-letter 首字下沉
 8. ::first-line  控制段落第一行
